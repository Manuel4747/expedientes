 ...
 */
@Entity
@Table(name = "exp_personas_inhibidas_por_documentos_judiciales")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ExpPersonasInhibidasPorDocumentosJudiciales.findAll", query = "SELECT d FROM ExpPersonasInhibidasPorDocumentosJudiciales d")
    , @NamedQuery(name = "ExpPersonasInhibidasPorDocumentosJudiciales.findByDocumentoJudicialEstado", query = "SELECT r FROM ExpPersonasInhibidasPorDocumentosJudiciales r WHERE r.documentoJudicial = :documentoJudicial AND r.estado = :estado ORDER BY r.persona.nombresApellidos")
    , @NamedQuery(name = "ExpPersonasInhibidasPorDocumentosJudiciales.findByDocumentoJudicial", query = "SELECT r FROM ExpPersonasInhibidasPorDocumentosJudiciales r WHERE r.documentoJudicial = :documentoJudicial")
    , @NamedQuery(name = "ExpPersonasInhibidasPorDocumentosJudiciales.findById", query = "SELECT d FROM ExpPersonasInhibidasPorDocumentosJudiciales d WHERE d.id = :id")})
public class ExpPersonasInhibidasPorDocumentosJudiciales implements Serializable {
    ...
    public ExpPersonasInhibidasPorDocumentosJudiciales() {
    }

    public ExpPersonasInhibidasPorDocumentosJudiciales(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        ExpPersonasInhibidasPorDocumentosJudiciales other = (ExpPersonasInhibidasPorDocumentosJudiciales) object;
    ...
    public String toString() {
        return "py.gov.jem.expedientes.models.ExpPersonasInhibidasPorDocumentosJudiciales[ id=" + id + " ]";
    }
