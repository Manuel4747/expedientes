...
import py.gov.jem.expedientes.facades.EstadosFacade;
...
@FacesConverter(value = "histPersonasAntecedenteConverter")
public class HistPersonasAntecedenteConverter implements Converter {

    private EstadosFacade ejbFacade;
    
    public HistPersonasAntecedenteConverter() {
        this.ejbFacade = CDI.current().select(EstadosFacade.class).get();
    }
