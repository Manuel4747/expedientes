 ...
 */
@Stateless
public class ExpPersonasFirmantesPorActuacionesFacade extends AbstractFacade<ExpPersonasFirmantesPorActuaciones> {
    ...
    public ExpPersonasFirmantesPorActuacionesFacade() {
