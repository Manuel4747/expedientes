 ...
 */
@Stateless
public class ExpEstadosProcesoExpedienteElectronicoFacade extends AbstractFacade<ExpEstadosProcesoExpedienteElectronico> {
    ...
    public ExpEstadosProcesoExpedienteElectronicoFacade() {
