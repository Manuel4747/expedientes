 ...
 */
@Stateless
public class ExpPersonasHabilitadasPorDocumentosJudicialesFacade extends AbstractFacade<ExpPersonasHabilitadasPorDocumentosJudiciales> {
    ...
    public ExpPersonasHabilitadasPorDocumentosJudicialesFacade() {
