 ...
 */
@Stateless
public class ExpProfesionalesPorPartesPorDocumentosJudicialesCorteFacade extends AbstractFacade<ExpProfesionalesPorPartesPorDocumentosJudicialesCorte> {
    ...
    public ExpProfesionalesPorPartesPorDocumentosJudicialesCorteFacade() {
