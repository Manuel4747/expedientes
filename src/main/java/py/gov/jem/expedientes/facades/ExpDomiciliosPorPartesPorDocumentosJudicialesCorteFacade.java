 ...
 */
@Stateless
public class ExpDomiciliosPorPartesPorDocumentosJudicialesCorteFacade extends AbstractFacade<ExpDomiciliosPorPartesPorDocumentosJudicialesCorte> {
    ...
    public ExpDomiciliosPorPartesPorDocumentosJudicialesCorteFacade() {
