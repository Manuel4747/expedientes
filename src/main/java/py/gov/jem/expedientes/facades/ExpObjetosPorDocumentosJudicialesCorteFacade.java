 ...
 */
@Stateless
public class ExpObjetosPorDocumentosJudicialesCorteFacade extends AbstractFacade<ExpObjetosPorDocumentosJudicialesCorte> {
    ...
    public ExpObjetosPorDocumentosJudicialesCorteFacade() {
