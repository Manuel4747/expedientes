 ...
 */
@Stateless
public class ExpPersonasFirmantesPorActasSesionFacade extends AbstractFacade<ExpPersonasFirmantesPorActasSesion> {
    ...
    public ExpPersonasFirmantesPorActasSesionFacade() {
