 ...
 */
@Stateless
public class ExpDocumentosJudicialesCortePorDocumentosJudicialesFacade extends AbstractFacade<ExpDocumentosJudicialesCortePorDocumentosJudiciales> {
    ...
    public ExpDocumentosJudicialesCortePorDocumentosJudicialesFacade() {
