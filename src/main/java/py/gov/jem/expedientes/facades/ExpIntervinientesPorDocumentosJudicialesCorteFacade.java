 ...
 */
@Stateless
public class ExpIntervinientesPorDocumentosJudicialesCorteFacade extends AbstractFacade<ExpIntervinientesPorDocumentosJudicialesCorte> {
    ...
    public ExpIntervinientesPorDocumentosJudicialesCorteFacade() {
