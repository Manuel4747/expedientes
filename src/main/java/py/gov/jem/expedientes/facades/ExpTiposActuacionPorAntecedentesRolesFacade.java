 ...
 */
@Stateless
public class ExpTiposActuacionPorAntecedentesRolesFacade extends AbstractFacade<ExpTiposActuacionPorAntecedentesRoles> {
    ...
    public ExpTiposActuacionPorAntecedentesRolesFacade() {
