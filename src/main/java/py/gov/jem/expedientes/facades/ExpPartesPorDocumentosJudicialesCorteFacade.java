 ...
 */
@Stateless
public class ExpPartesPorDocumentosJudicialesCorteFacade extends AbstractFacade<ExpPartesPorDocumentosJudicialesCorte> {
    ...
    public ExpPartesPorDocumentosJudicialesCorteFacade() {
