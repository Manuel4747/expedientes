 ...
 */
@Stateless
public class ExpPartesPorDocumentosJudicialesFacade extends AbstractFacade<ExpPartesPorDocumentosJudiciales> {
    ...
    public ExpPartesPorDocumentosJudicialesFacade() {
