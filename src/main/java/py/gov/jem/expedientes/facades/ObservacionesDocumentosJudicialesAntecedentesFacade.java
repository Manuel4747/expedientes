 ...
 */
@Stateless
public class ObservacionesDocumentosJudicialesAntecedentesFacade extends AbstractFacade<ObservacionesDocumentosJudicialesAntecedentes> {
    ...
    public ObservacionesDocumentosJudicialesAntecedentesFacade() {
