...
public class WordInsertHTMLaltChunkInDocument {
 ...
 public void generar() throws Exception {
  ...
  XWPFDocument document = new XWPFDocument(new FileInputStream("/home/eduardo/expedientes/template.docx"));
  ...
  FileOutputStream out = new FileOutputStream("/home/eduardo/expedientes/result.docx");
  document.write(out);
  out.close();
  document.close();
