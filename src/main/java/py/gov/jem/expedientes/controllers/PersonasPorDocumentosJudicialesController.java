...
public class PersonasPorDocumentosJudicialesController extends AbstractController<PersonasPorDocumentosJudiciales> {
    ...
    protected void setEmbeddableKeys() {
        ...
        this.getSelected().getPersonasPorDocumentosJudicialesPK().setDocumentoJudicial(this.getSelected().getDocumentoJudicial().getId());
    }

    @Override
    protected void initializeEmbeddableKey() {
        this.getSelected().setPersonasPorDocumentosJudicialesPK(new py.gov.jem.expedientes.models.PersonasPorDocumentosJudicialesPK());
    }
