...
@Named(value = "graciasPersonaExpedienteController")
@ViewScoped
public class GraciasPersonaExpedienteController extends AbstractController<PedidosPersona> {
    ...
    public GraciasPersonaExpedienteController() {
