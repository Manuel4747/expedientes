...
@Named(value = "validacionesEmailController")
@ViewScoped
public class ValidacionesEmailController extends AbstractController<PedidosPersona> {
    ...
    public ValidacionesEmailController() {
    ...
    public void initParams() {
        ...
        if (hash != null) {
            try {
                ...
                try {
                    FacesContext.getCurrentInstance().getExternalContext().redirect("/" + endpoint + "/faces/pages/validacionesEmail/Caducado.xhtml");
                    return;
            ...
            try {
                FacesContext.getCurrentInstance().getExternalContext().redirect("/" + endpoint + "/faces/pages/validacionesEmail/HashNoValido.xhtml");
                return;
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        ...
        if (val != null) {
            ...
            if (val.getPersona() != null) {
                ...
                if (val != null) {
                    ...
                    mensaje = "SU USUARIO HA SIDO VALIDADO. EN 24 HS RECIBIRA UN EMAIL CON LA ACTIVACION DEL MISMO";
                }
